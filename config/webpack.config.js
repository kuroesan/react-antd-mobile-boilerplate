    ...
    if (preProcessor) {
      loaders.push({
        ...
        options: {
          ...
          sourceMap: true//isEnvProduction ? shouldUseSourceMap : isEnvDevelopment,
        },
      });
    }
    return loaders;
      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
            ...
            {
              include: /node_modules|antd-mobile\.less/,
              test: /(\.less|\.css)$/,
              use: [{
            ...
            },
            {
              ...
              use: [{
                ...
                loader: "less-loader?modules&importLoaders=1&localIdentName=[local]_[hash:base64:5]",
                options: {
                  javascriptEnabled: true,
                  sourceMap: true
                }
